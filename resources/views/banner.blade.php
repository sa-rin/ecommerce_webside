...
@section('subtitle', 'Create banner image for homepage promotional areas')
    ...
    <form action="{{ route('banner.store') }}" method="POST" enctype="multipart/form-data">
            ...
            <div class="col-lg-8">
                <div class="mb-4">
                    ...
                    <input type="text" name="Title" class="form-control form-control-premium" 
                           value="{{ old('Title') }}" placeholder="Display title on the banner">
                </div>

                <div class="row g-4 mb-4">
                    <div class="col-md-12">
                        <label class="form-label fw-bold text-dark">URL / Link (optional)</label>
                        <div class="input-group">
                            ...
                            <input type="text" name="Link" class="form-control form-control-premium border-start-0" 
                                   value="{{ old('Link') }}" placeholder="https://ecommerce.com/promo">
                        </div>
                    </div>
                </div>
                ...
                <div class="p-4 rounded-4 border border-dashed bg-light bg-opacity-50 text-center mb-0">
                    ...
                    <h6 class="fw-bold text-dark">Banner Graphic</h6>
                    <p class="small text-muted mb-3">Upload a clean banner image (PNG, JPG, WEBP)</p>
                    <div class="mx-auto" style="max-width: 300px;">
                        <input type="file" name="BannerImage" class="form-control form-control-sm" 
                               accept="image/*" onchange="previewImg(event,'bannerPreview')" required>
                    </div>
                </div>
            </div>

            <div class="col-lg-4">
                <label class="form-label fw-bold text-dark mb-3">Live Preview</label>
                <div class="ratio ratio-21x9 border rounded-4 bg-white shadow-sm overflow-hidden">
                    <div class="d-flex align-items-center justify-content-center">
                        <div id="bannerPreviewPlaceholder" class="text-center opacity-25">
                            <i class="bi bi-image fs-1 d-block mb-1"></i>
                            <div class="small fw-bold">Graphic Preview</div>
                        </div>
                        <img id="bannerPreview" src="" class="img-fluid d-none" style="object-fit: cover; max-height: 100%; width: 100%;">
                    </div>
                </div>
                <div class="mt-3 p-3 rounded-4 bg-info-subtle border border-info-subtle text-info-emphasis small">
                    <i class="bi bi-info-circle-fill me-1"></i>
                    Banners are usually displayed in a wide aspect ratio (e.g., 1200x400px).
                </div>
            </div>
        </div>
        ...
        <div class="mt-5 pt-4 border-top d-flex justify-content-end gap-3">
            ...
            <button type="submit" class="btn btn-premium-primary px-5 rounded-pill">
                <i class="bi bi-cloud-check me-1"></i> Create Banner
            </button>
        </div>
    </form>
</div>
